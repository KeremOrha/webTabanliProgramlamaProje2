...
<?php 
 ...
 if ($_SESSION['yonetici_mi'] != 1){ 
   ...
   require('vtbaglan.php'); 
	...
	$id = $_GET['id'];
	$sql2 = "SELECT * FROM uye WHERE uye_id = '$id'";
	$cevap2 = mysqli_query($baglanti,$sql2);
	
	$uye = mysqli_fetch_assoc($cevap2);
   if (isset($_POST['name'])){ 
   ...
   extract($_POST); 
	...
	$sql->bind_param( "sii",  $name,  $yonetici,  $id);
            ...
            <div class="p-5 bg-white border rounded-3 shadow">
                ...
                <form action="<?php $_PHP_SELF ?>" method="POST">
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" value="<?php echo $uye['uye_ad']; ?>" name="name" placeholder="Üye Adı" required>
					</div>
					...
					<div class="mb-3">
						<a href='uyeDuzenle.php'>Düzenlemeye geri dön</a>
					</div>
				</form>
            </div>
